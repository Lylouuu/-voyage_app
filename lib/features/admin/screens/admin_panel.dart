...
class _AdminPanelState extends State<AdminPanel> {
  ...
  final List<_SidebarItem> _menuItems = [
    ...
    _SidebarItem(icon: Icons.public_rounded, label: 'Pays'),
    _SidebarItem(icon: Icons.location_city_rounded, label: 'Villes'),
    _SidebarItem(icon: Icons.local_activity_rounded, label: 'Activités'),
    _SidebarItem(icon: Icons.account_balance_rounded, label: 'Monuments'),
    _SidebarItem(icon: Icons.restaurant_rounded, label: 'Restaurants'),
    _SidebarItem(icon: Icons.hotel_rounded, label: 'Hôtels'),
    _SidebarItem(icon: Icons.people_rounded, label: 'Utilisateurs'),
    _SidebarItem(icon: Icons.star_rounded, label: 'Avis'),
    _SidebarItem(icon: Icons.flight_rounded, label: 'Plans de voyage'),
  ];
          ...
          children: [
            Container(
              ...
              child: const Column(
                ...
                children: [
                  Text('Gestion', style: TextStyle(color: AdminTheme.textPrimary, fontSize: 28, fontWeight: FontWeight.bold)),
                  SizedBox(height: 5),
                  Text('Sélectionnez une catégorie à gérer', style: TextStyle(color: AdminTheme.textSecondary, fontSize: 15)),
                ],
              ),
            ),
            Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Icon(item.icon, color: AdminTheme.accent, size: 28),
                            ),
                            const SizedBox(height: 12),
                            Text(
                              item.label,
                              style: const TextStyle(color: AdminTheme.textPrimary, fontSize: 14, fontWeight: FontWeight.w600),
              ...
              Container(
                ...
                child: Center(
                  child: Text(
                    ...
                    style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 32),
                  ),
                ),
              ),
              const SizedBox(height: 16),
              Text(widget.adminData['nom'] ?? 'Administrateur', style: const TextStyle(color: AdminTheme.textPrimary, fontSize: 24, fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              Text(widget.adminData['email'] ?? '', style: const TextStyle(color: AdminTheme.textSecondary, fontSize: 16)),
